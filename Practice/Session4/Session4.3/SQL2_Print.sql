...
-- print is  used to debug the  queries to print the messages during exection 
--print prints the output to the message tab not on  result tab 
--Syntax :
...
begin
	...
	begin catch
		...
		begin
			set @AverageBalance = 0
			print 'There are no valid employees in this range.'  -- prints the messages 
			Return 8134
		end
		else
