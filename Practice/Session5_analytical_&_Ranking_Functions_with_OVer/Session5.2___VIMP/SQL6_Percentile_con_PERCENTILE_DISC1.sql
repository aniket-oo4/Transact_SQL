...
--
-- Percentile_Cont(1)  -- 1  represents 100% 0.4 -- 40%

 -- taking 75% of total attendance of specific employee
SELECT DISTINCT EmployeeNumber,
PERCENTILE_CONT(0.75) WITHIN GROUP (ORDER BY NumberAttendance) OVER (PARTITION BY EmployeeNumber) as AverageCont,
PERCENTILE_DISC(0.75) WITHIN GROUP (ORDER BY NumberAttendance) OVER (PARTITION BY EmployeeNumber) as AverageDisc
from tblAttendance
