...
select dbo.fnc_TransactionTotal(127)
...
create function fnc_TransactionAll (@intEmployee as int) -- multistatement table function
...
from dbo.tblEmployee as E
outer apply fnc_TransactionAll(EmployeeNumber) as T  -- outer apply used because it allows joins on function returns 
